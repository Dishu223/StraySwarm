...
namespace StraySwarm.Editor
{
    ...
    public static class AutoWireSceneReferences
    {
        ...
        public static void AutoWireAll()
        {
            ...
            // 9. Remove any obsolete LevelBuilder component from GameManager
            if (gmGo != null)
            {
                var obsoleteLb = gmGo.GetComponent("LevelBuilder");
                if (obsoleteLb != null) Object.DestroyImmediate(obsoleteLb);
            }
